...
export const paisesLista = [
    'Afghanistan', 'Malaysia', 'Rwanda', 'Mongolia', 'Bahamas', 'Belarus', 'American Samoa', 'French Guiana', 'Saint Barthélemy', 'Belize', 'Suriname', 'Haiti', 'France', 'Chile', 'Venezuela', 'Bolivia', 'Peru', 'Argentina', 'Mexico', 'Spain', 'Colombia', 'Ecuador', 'Puerto Rico', 'Italia', 'Turkey', 'North Korea', 'Germany', 'Russia', 'Thailand', 'Malaysia', 'Austria', 'Greece', 'Canada', 'Poland', 'South Korea', 'Japan', 'Sweden', 'Albania', 'Vanuatu', 'Mauritius', 'Portugal', 'Ivory Coast', 'Georgia', 'Bhutan', 'Namibia', 'Netherlands', 'Uruguay', 'Belgium', 'Guernsey', 'United States Virgin Islands', 'Uganda', 'Liechtenstein', 'Guinea-Bissau', 'Cuba', 'Montenegro', 'Norway', 'Saint Vincent and the Grenadines', 'Mayotte', 'Latvia', 'Paraguay', 'Jersey', 'Laos', 'Qatar', 'Dominican Republic', 'Slovakia', 'Bosnia and Herzegovina', 'Panama', 'Barbados', 'Cambodia', 'Antigua and Barbuda'
]
